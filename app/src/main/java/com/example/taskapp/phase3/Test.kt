...
//                    HorizontalDivider()
//                }
//                NavigationDrawerItem(label = { Text("Daily goals") }, selected = false, onClick = {})
//                HorizontalDivider()
//                NavigationDrawerItem(label = { Text("Completed tasks") }, selected = false, onClick = {})
//                HorizontalDivider()
